...
***Assignment Exercises***
  ...
  1. Create an R script saved as "LastnameSetup1.R" (use your last name) or Rmd file "LastnameSetup1.Rmd". Within this file, make sure to title it and provide your name. 
